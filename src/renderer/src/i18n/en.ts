...
const en: Locale = {
  ...
  confirm: {
    ...
    deleteMessage: 'This will remove the app and all its data (chat history, login state, etc.). This action cannot be undone.',
    updateTitle: 'Confirm Update',
    updateMessage: 'This will delete the current clone and re-create from the latest original WeChat. Chat data will be preserved.'
  },
  faq: {
    title: 'FAQ',
    items: [
  ...
  errors: {
    ...
    ERR_COPY_FAILED: 'Copy failed, possibly due to insufficient permissions. Please grant access in System Settings -> Privacy & Security.',
    ...
    ERR_UPDATE_REBUILD_FAILED: 'Copy failed. The old clone was successfully deleted but could not be rebuilt:'
  },
  progress: {
